...
# Description:
#   Search for known-text in Deepwave Digital, Inc. software license
...
result=$(grep -e 'License For Customer Use of Deepwave Digital Software' "$copyrightfile")
if [ -n "$result" ]; then
  echo "Deepwave-Proprietary"
fi
